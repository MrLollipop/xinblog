<template>
  <div class="mod-home">
    ...
    <h3>项目开源地址</h3>
    <ul>
      <li>Gitee：<a href="https://gitee.com/xinge2021/xinblog">https://gitee.com/xinge2021/xinblog</a></li>
      <li>GitHub:<a href="https://github.com/MrLollipop/xinblog">https://github.com/MrLollipop/xinblog</a></li>
    </ul>
    <!-- <h3>获取帮助</h3>
    <ul>
