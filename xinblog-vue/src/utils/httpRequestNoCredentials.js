 ...
 */
 http.adornUrlByProxy = (actionName, proxyUrl) => {
  // 非生产环境 && 开启代理, 接口前缀统一使用[/proxyApi/]前缀做代理拦截!
  // return (process.env.NODE_ENV !== 'production' && process.env.OPEN_PROXY ? proxyUrl : process.env.ossUrl) + actionName
  return (process.env.OPEN_PROXY ? proxyUrl : process.env.ossUrl) + actionName;
}
...
export default http
// export default httpNoCredentials
